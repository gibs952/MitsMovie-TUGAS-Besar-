...
$username = $_POST["username"];
  ...
  if(mysqli_num_rows($result) == 1){
    ...
    if(password_verify($password, $row["password1"])){
      ...
      mysqli_query($koneksi, "UPDATE data_registrasi SET password1='$password3' WHERE username = '$username'");
      // keluar session
      session_start();
      $_SESSION =[];
      session_unset();
                    ...
                    <form class="mx-1 mx-md-4" method="post">
                      ...
                      <div class="d-flex row-cols-md-3 justify-content-center mx-4 mb-3 mb-lg-4 ">
                        <div class="col text-center">
                          <button type="submit" name="edit" class="btn btn-primary btn-lg btn-hover animate__animated animate__backInUp">Ubah</button>
                        </div>
                        <div class="col text-center ">
