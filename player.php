  ...
  <body>
    <section id="navbar">
      ...
      <nav class="navbar fixed-top navbar-expand-lg gd-mantap">
        <div class="container">
          <a class="navbar-brand" href="#pemutar">
          ...
          <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav ms-auto">
              <a class="nav-link text-white" aria-current="page" href="#pemutar">Home</a>
              <a class="nav-link text-white" href="#semua-film">All film</a>
              <a class="nav-link text-white" href="#about">About</a>
              <button type="button" class="btn btn-secondary" onclick="document.location='laman-film.php'">Dashboard</button>
            </div>
          </div>
        </div>
      </nav>
    ...
    <section id="pemutar">
      ...
      <video controls>
        <source src="answer.mp4" type="video/mp4">
        <!-- <source src="movie.ogg" type="video/ogg"> -->
        Your browser does not support the video tag.
      </video>
      h1
        <!-- <iframe class="embed-responsive-item" src="answer.mp4"></iframe></div> -->
      </div>
    </div>
    </section>
    <!-- akhir caraousel -->
